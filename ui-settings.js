...
function syncSettings(){
  ...
  $('showTime').checked=S.chatOpt.showTime!==false;$('fontSize').value=S.chatOpt.fontSize||15;$('fzVal').textContent=(S.chatOpt.fontSize||15)+'px';if($('sysFontSize')){$('sysFontSize').value=S.chatOpt.sysFontSize||12;$('sysFzVal').textContent=(S.chatOpt.sysFontSize||12)+'px';}
  ...
  setBg($('globalBgThumb'),S.globalBg||'');if($('globalCallBgThumb')) setBg($('globalCallBgThumb'),S.globalCallBg||'');
...
function pullSettings(){
  ...
  S.chatOpt.showTime=$('showTime').checked;S.chatOpt.fontSize=+$('fontSize').value||15;if($('sysFontSize')) S.chatOpt.sysFontSize=+$('sysFontSize').value||12;
...
// 全局通话背景的选择与清除
if($('globalCallBgPick')) {
  $('globalCallBgPick').onclick=()=>pickImage(d=>{S.globalCallBg=d;save();setBg($('globalCallBgThumb'),d)});
  $('globalCallBgClear').onclick=()=>{S.globalCallBg='';save();setBg($('globalCallBgThumb'),'')};
}
